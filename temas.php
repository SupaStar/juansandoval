...
<section data-aos="fade-down" id="temas-interes" class="about-us" style="padding-top: 30px;padding-bottom: 50px;">
    <div class="container">
        ...
        <div class="row" style="padding-top: 50px;border-bottom: 1px solid rgb(0,56,105) ;">
            ...
            <div class="col">
            <div class=" pulse animated collapse" id="collapseHipotecario" style="margin-bottom: 20px;">
                ...
                <h2 style="color: rgb(0,0,0);font-family: Thasadith, sans-serif;font-size: 15px;text-align: justify;">Es
                    ...
                    cuanto rama jurídica dedicada a las normas sobre<br>inmuebles. Asimismo, y en otro sentido, podría
                    ...
                    perjuicio de que ésta pueda considerarse como rama del tronco común del Derecho civil.<br><br>El
                    ...
                    particular y la administración pública. <br>Es decir, se encarga de regular todas las transacciones
                    ...
                    normas que regulan las comunidades de vecinos.<br></h2>
                ...
                <h2 style="color: rgb(0,0,0);font-family: Thasadith, sans-serif;font-size: 15px;text-align: justify;padding-right: 15px;padding-left: 15px;">
                    <label style="color: rgb(225,178,24);height: 13px;">La regulación de los derechos reales sobre un
            ...
            <div class="pulse animated collapse" id="collapseCivil" style="margin-bottom: 20px;>
            ...
            <h2 style="color: rgb(0,56,105);font-family: Thasadith, sans-serif;font-size: 20px;text-align: justify;">El
            ...
            <h2 style="color: rgb(0,0,0);font-family: Thasadith, sans-serif;font-size: 15px;text-align: justify;">Para
                ...
                producen los actos jurídicos.<br><br>El Derecho Civil es la rama del derecho privado que contempla temas
                ...
                judiciales competentes en materia civil.<br><br>La ley dispone que por parte del Estado para conocer o
                ...
                actuarios o el Registro Público de la Propiedad.<br></h2>
            <h2 style="color: rgb(0,0,0);font-family: Thasadith, sans-serif;font-size: 15px;text-align: justify;padding-right: 15px;padding-left: 15px;">
            ...
            <h2 style="color: rgb(0,0,0);font-family: Thasadith, sans-serif;font-size: 15px;text-align: justify;padding-right: 15px;padding-left: 15px;">
                <label style="color: rgb(225,178,24);height: 12px;">La Propiedad.&nbsp;<br></label>&nbsp;En virtud de la
                ...
                y la accesión.<br></h2>
            <h2 style="color: rgb(0,0,0);font-family: Thasadith, sans-serif;font-size: 15px;text-align: justify;padding-right: 15px;padding-left: 15px;">
                <label style="color: rgb(225,178,24);height: 12px;">La Posesión.&nbsp;<br></label>&nbsp;La posesión no
            ...
            <h2 style="color: rgb(0,0,0);font-family: Thasadith, sans-serif;font-size: 15px;text-align: justify;padding-right: 15px;padding-left: 15px;">
                ...
                inscrito en el Registro Público para que sea válido y sea reconocido<br>frente a terceros.<br><br>En la
                ...
                tribunales judiciales competentes.<br></h2>
        </div>
        <div class=" pulse animated collapse" id="collapseMercantil" style="margin-bottom: 20px;>
            <h1 style=" color: rgb(225,178,24);font-family: Thasadith, sans-serif;
        "></h1>
        <h1 style="color: rgb(225,178,24);font-family: Thasadith, sans-serif;">Derecho Mercantil</h1>
        <h2 style="color: rgb(0,56,105);font-family: Thasadith, sans-serif;font-size: 20px;text-align: justify;">En
            ...
            comercio. <br></h2>
        <h2 style="color: rgb(0,0,0);font-family: Thasadith, sans-serif;font-size: 15px;text-align: justify;">En este
        ...
        <h2 style="color: rgb(0,0,0);font-family: Thasadith, sans-serif;font-size: 15px;text-align: justify;padding-right: 30px;padding-left: 30px;">
    ...
    <div class="pulse animated collapse" id="collapseFamiliar" style="margin-bottom: 20px;>
            <h1 style=" color: rgb(225,178,24);font-family: Thasadith, sans-serif;
    "></h1>
    <h1 style="color: rgb(225,178,24);font-family: Thasadith, sans-serif;">Derecho Familiar</h1>
    <h2 style="color: rgb(0,56,105);font-family: Thasadith, sans-serif;font-size: 20px;text-align: justify;">Conjunto de
    ...
    <h2 style="color: rgb(0,0,0);font-family: Thasadith, sans-serif;font-size: 15px;text-align: justify;">Es la parte
        ...
        <br></h2>
    <h2 style="color: rgb(0,0,0);font-family: Thasadith, sans-serif;font-size: 15px;text-align: justify;">El Derecho
    ...
    <div class="pulse animated collapse" id="collapsePenal" ;>
        ...
        <h2 style="color: rgb(0,0,0);font-family: Thasadith, sans-serif;font-size: 15px;text-align: justify;padding-right: 15px;padding-left: 15px;">
            <label style="color: rgb(225,178,24);height: 12px;"><strong>Legislación Aplicable en el Derecho Penal
                ...
                cometieron.</strong><br><br><strong>Los Códigos Penales Estatales se aplicarán a los delitos que esos
                ...
                de exclusión de delito; tentativa, reincidencia; y otros.</strong><br><br></h2>
        <h2 style="color: rgb(0,0,0);font-family: Thasadith, sans-serif;font-size: 15px;text-align: justify;padding-right: 15px;padding-left: 15px;">
