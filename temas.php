...
<head>
    ...
    <title>Temas de Interes - Juan Sandoval Asociados</title>
...
<header data-aos="fade" data-aos-duration="900" class="masthead"
    ...
    <div class="container" id="header" style="max-width: 100%;background: rgba(10,10,10,0.49);">
        <div class="intro-text text-center" style="padding-top: 150px;padding-bottom: 150px;">
            <p class="" style="font-size: 40px;font-family: Thasadith, sans-serif;font-weight: bold;">TEMAS DE
                INTERES</p>
...
<section data-aos="fade-down" id="temas-interes" class="about-us" style="padding-top: 30px;padding-bottom: 50px;">
    <div class="container">
        ...
        <div class="row" style="padding-top: 50px;border-bottom: 1px solid rgb(0,56,105) ;">
                ...
                <div class="row">
                    <div class="col flex-column flex-column">
                        <ul class="nav nav-tabs flex-column">
                            <li class="nav-item"><a id="navHipotecario"
                                                    ...
                                                    data-toggle="collapse" data-target="collapseHipotecario"
                                                    aria-expanded="false" aria-controls="collapseExample">Derecho
                                    Hipotecario</a></li>
                            <li class="nav-item"><a id="navCivil"
                                                    class="lista nav-link text-capitalize js-scroll-trigger" href="#"
                                                    style="background: rgba(255,255,255,0);border-style: none;font-size: 25px;font-weight: 700;font-family: Thasadith, sans-serif;color: rgb(0,56,105);"
                                                    data-toggle="collapse" aria-expanded="false"
                                                    aria-controls="collapseExample">Derecho Civil</a></li>
                            <li class="nav-item"><a id="navMercantil" class="lista nav-link" href="#"
                                                    style=" background: rgba(255,255,255,0);border-style: none;font-size: 25px;font-weight: 700;font-family: Thasadith, sans-serif;color: rgb(0,56,105);"
                                                    data-toggle="collapse" aria-expanded="false"
                                                    aria-controls="collapseExample">Derecho Mercantil</a></li>
                            <li class="nav-item"><a id="navFamiliar" class="lista nav-link" href="#"
                                                    style="background: rgba(255,255,255,0);border-style: none;font-size: 25px;font-weight: 700;font-family: Thasadith, sans-serif;color: rgb(0,56,105);"
                                                    data-toggle="collapse" aria-expanded="false"
                                                    aria-controls="collapseExample">Derecho Familiar</a></li>
                            <li class="nav-item"><a id="navPenal" class="lista nav-link" href="#"
                                                    style="background: rgba(255,255,255,0);border-style: none;font-size: 25px;font-weight: 700;font-family: Thasadith, sans-serif;color: rgb(0,56,105);"
                                                    data-toggle="collapse" aria-expanded="false"
                                                    aria-controls="collapseExample">Derecho Penal</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            <div class="col">
            <div class="  collapse" id="collapseHipotecario" style="margin-bottom: 20px;">
                <h1 style="color: rgb(225,178,24);font-family: Thasadith, sans-serif;">Derecho Hipotecario</h1>
                <h2 style="    text-indent: 10px;color: rgb(0,56,105);font-family: Thasadith, sans-serif;font-size: 20px;text-align: left;">
                    ...
                    extinción del dominio sobre bienes inmuebles y derechos reales sobre los mismos.<br></h2>
                <h2 style="    text-indent: 10px;color: rgb(0,0,0);font-family: Thasadith, sans-serif;font-size: 15px;text-align: left;">Es
                    ...
                    perjuicio de que ésta pueda considerarse como rama del tronco común del Derecho civil.<br><br><label style="text-indent: 10px">El
                    Derecho inmobiliario es el conjunto de normas y leyes que regula todas las operaciones que pueden
                    realizarse sobre los bienes que la ley define como raíces -aquellos que por sus características
                    físicas no pueden desplazarse del lugar en que se encuentran-, tanto entre ciudadanos como entre un
                        particular y la administración pública.</label> <br><label style="text-indent: 10px;">Es decir, se encarga de regular todas las transacciones
                    inmobiliarias: la forma en que se crean, transmite, modifican, adquieren o extinguen los derechos
                    que una persona física o jurídica tiene sobre una propiedad inmueble o parte de ella, así como de
                    los impuestos y gravámenes que debe hacer frente por cada una de estas operaciones. También abarca
                    los aspectos referentes a la gestión de estos inmuebles, es decir, licencias urbanas, de obras o las
                    normas que regulan las comunidades de vecinos.</label><br></h2>
                ...
                <h2 style="    text-indent: 10px;color: rgb(0,0,0);font-family: Thasadith, sans-serif;font-size: 15px;text-align: left;">
                    ...
                    las decisiones pertinentes y cumplir las obligaciones legales.<br></h2>
            </div>
            <div class=" collapse" id="collapseCivil" style="margin-bottom: 20px;>
                <h1 style=" color: rgb(225,178,24);font-family: Thasadith, sans-serif;
            "></h1>
            <h1 style="color: rgb(225,178,24);font-family: Thasadith, sans-serif;">Derecho Civil</h1>
            <h2 style="    text-indent: 10px;color: rgb(0,56,105);font-family: Thasadith, sans-serif;font-size: 20px;text-align: left;">El
                Derecho Civil en México se ocupa de regular los derechos y obligaciones de los individuos desde el
                momento de su concepción hasta su muerte. <br></h2>
            <h2 style="    text-indent: 10px;color: rgb(0,0,0);font-family: Thasadith, sans-serif;font-size: 15px;text-align: left;">Para
                ...
                producen los actos jurídicos.<br><br><label style="text-indent: 10px">El Derecho Civil es la rama del derecho privado que contempla temas
                relativos a las personas, los bienes, las sucesiones, las obligaciones y los contratos. Las
                controversias que se susciten en relación con estos temas serán del conocimiento de los tribunales
                    judiciales competentes en materia civil.</label><br><br><label style="text-indent: 10px">La ley dispone que por parte del Estado para conocer o
            ...
            <h2 style="    text-indent: 10px;color: rgb(0,0,0);font-family: Thasadith, sans-serif;font-size: 15px;text-align: left;">
                ...
                adopción, entre otros.<br>Las disposiciones del código civil además de regular a las personas físicas,
            ...
            <h2 style="    text-indent: 10px;color: rgb(0,0,0);font-family: Thasadith, sans-serif;font-size: 15px;text-align: left;">
                ...
                inscrito en el Registro Público para que sea válido y sea reconocido<br>frente a terceros.<br><br><label style="text-indent: 10px">En la
                práctica se puede dar el caso de que pese a la existencia de un contrato en el cual fueron estipulados
                los derechos y obligaciones de las partes, una de ellas o todas las partes contratantes incumplan en
                forma total o parcial con el contrato, en este caso las partes podrán exigirse el cumplimiento de las
                obligaciones pactadas o bien rescindir el contrato y puede hacerse de pleno derecho, sin necesidad de
                acudir ante las autoridades judiciales según se haya estipulado en el contrato o bien acudiendo ante los
                    tribunales judiciales competentes.</label><br></h2>
        </div>
        <div class="  collapse" id="collapseMercantil" style="margin-bottom: 20px;>
            <h1 style=" color: rgb(225,178,24);font-family: Thasadith, sans-serif;
        "></h1>
        ...
        <h2 style="    text-indent: 10px;color: rgb(0,56,105);font-family: Thasadith, sans-serif;font-size: 20px;text-align: left;">En
            ...
            comercio. <br></h2>
        <h2 style="    text-indent: 10px;color: rgb(0,0,0);font-family: Thasadith, sans-serif;font-size: 15px;text-align: left;">En este
        ...
        <h2 style="    text-indent: 10px;color: rgb(0,0,0);font-family: Thasadith, sans-serif;font-size: 15px;text-align: left;">
            ...
            los actos de comercio contemplados por la ley. Los reproducimos a continuación:<br></h2>
        <h2 style="    text-indent: 10px;color: rgb(0,0,0);font-family: Thasadith, sans-serif;font-size: 15px;text-align: left;padding-right: 30px;padding-left: 30px;">
            ...
            labrados.<br></h2>
        <h2 style="    text-indent: 10px;color: rgb(0,0,0);font-family: Thasadith, sans-serif;font-size: 15px;text-align: left;padding-right: 30px;padding-left: 30px;">
            2. Las compras y ventas de bienes inmuebles, cuando se hagan con propósito de especulación comercial.<br>
        </h2>
        <h2 style="    text-indent: 10px;color: rgb(0,0,0);font-family: Thasadith, sans-serif;font-size: 15px;text-align: left;padding-right: 30px;padding-left: 30px;">
            3.&nbsp;Las compras y ventas de porciones, acciones y obligaciones de las sociedades mercantiles.<br></h2>
        <h2 style="    text-indent: 10px;color: rgb(0,0,0);font-family: Thasadith, sans-serif;font-size: 15px;text-align: left;padding-right: 30px;padding-left: 30px;">
            4. Los contratos relativos y obligaciones del Estado u otros títulos de crédito corrientes en el
            comercio.<br></h2>
        <h2 style="    text-indent: 10px;color: rgb(0,0,0);font-family: Thasadith, sans-serif;font-size: 15px;text-align: left;padding-right: 30px;padding-left: 30px;">
            5. Las empresas de abastecimientos y suministros.<br></h2>
        <h2 style="    text-indent: 10px;color: rgb(0,0,0);font-family: Thasadith, sans-serif;font-size: 15px;text-align: left;padding-right: 30px;padding-left: 30px;">
            6.&nbsp;<strong>Las empresas de construcciones, y trabajos públicos y privados.</strong><br></h2>
        <h2 style="    text-indent: 10px;color: rgb(0,0,0);font-family: Thasadith, sans-serif;font-size: 15px;text-align: left;padding-right: 30px;padding-left: 30px;">
            7. Las empresas de fábricas y manufacturas.<br></h2>
        <h2 style="    text-indent: 10px;color: rgb(0,0,0);font-family: Thasadith, sans-serif;font-size: 15px;text-align: left;padding-right: 30px;padding-left: 30px;">
            8.&nbsp;<strong>Las empresas de trasportes de personas o cosas, por tierra o por agua; y las empresas de
                turismo.</strong></h2>
        <h2 style="    text-indent: 10px;color: rgb(0,0,0);font-family: Thasadith, sans-serif;font-size: 15px;text-align: left;padding-right: 30px;padding-left: 30px;">
            9.&nbsp;<strong>Las librerías, y las empresas editoriales y tipográficas.</strong></h2>
        <h2 style="    text-indent: 10px;color: rgb(0,0,0);font-family: Thasadith, sans-serif;font-size: 15px;text-align: left;padding-right: 30px;padding-left: 30px;">
            10.&nbsp;<strong>Las empresas de comisiones, de agencias, de oficinas de negocios comerciales, casas de
                empeño y establecimientos de ventas en pública almoneda.</strong></h2>
        <h2 style="    text-indent: 10px;color: rgb(0,0,0);font-family: Thasadith, sans-serif;font-size: 15px;text-align: left;padding-right: 30px;padding-left: 30px;">
            11.<strong>Las empresas de espectáculos públicos.</strong></h2>
        <h2 style="    text-indent: 10px;color: rgb(0,0,0);font-family: Thasadith, sans-serif;font-size: 15px;text-align: left;padding-right: 30px;padding-left: 30px;">
            12.&nbsp;<strong>Las operaciones de comisión mercantil.</strong></h2>
        <h2 style="    text-indent: 10px;color: rgb(0,0,0);font-family: Thasadith, sans-serif;font-size: 15px;text-align: left;padding-right: 30px;padding-left: 30px;">
            13.&nbsp;<strong>Las operaciones de mediación de negocios mercantiles</strong></h2>
        <h2 style="    text-indent: 10px;color: rgb(0,0,0);font-family: Thasadith, sans-serif;font-size: 15px;text-align: left;padding-right: 30px;padding-left: 30px;">
            14.&nbsp;<strong>Las operaciones de bancos</strong></h2>
        <h2 style="    text-indent: 10px;color: rgb(0,0,0);font-family: Thasadith, sans-serif;font-size: 15px;text-align: left;padding-right: 30px;padding-left: 30px;">
            15.&nbsp;<strong>Todos los contratos relativos al comercio marítimo y a la navegación interior y
                exterior.</strong></h2>
        <h2 style="    text-indent: 10px;color: rgb(0,0,0);font-family: Thasadith, sans-serif;font-size: 15px;text-align: left;padding-right: 30px;padding-left: 30px;">
            16.&nbsp;<strong>Los contratos de seguros de toda especie.</strong></h2>
        <h2 style="    text-indent: 10px;color: rgb(0,0,0);font-family: Thasadith, sans-serif;font-size: 15px;text-align: left;padding-right: 30px;padding-left: 30px;">
            17.&nbsp;<strong> Los depósitos por causa de comercio.</strong></h2>
        <h2 style="    text-indent: 10px;color: rgb(0,0,0);font-family: Thasadith, sans-serif;font-size: 15px;text-align: left;padding-right: 30px;padding-left: 30px;">
            18.&nbsp;<strong>Los depósitos en los almacenes generales y todas las operaciones hechas sobre los
                certificados de depósito y bonos de prenda.</strong></h2>
        <h2 style="    text-indent: 10px;color: rgb(0,0,0);font-family: Thasadith, sans-serif;font-size: 15px;text-align: left;padding-right: 30px;padding-left: 30px;">
            19.&nbsp;<strong>Los cheques, letras de cambio o remesas de dinero de una plaza a otra.</strong></h2>
        <h2 style="    text-indent: 10px;color: rgb(0,0,0);font-family: Thasadith, sans-serif;font-size: 15px;text-align: left;padding-right: 30px;padding-left: 30px;">
            20.&nbsp;<strong>* Los vales u otros títulos a la orden o al portador, y las obligaciones de los
                comerciantes, a no ser que se pruebe que se derivan de una causa extraña al comercio</strong></h2>
        <h2 style="    text-indent: 10px;color: rgb(0,0,0);font-family: Thasadith, sans-serif;font-size: 15px;text-align: left;padding-right: 30px;padding-left: 30px;">
            21.&nbsp;&nbsp;<strong>Las obligaciones entre comerciantes y banqueros, si no son de naturaleza
                esencialmente civil.</strong></h2>
        <h2 style="    text-indent: 10px;color: rgb(0,0,0);font-family: Thasadith, sans-serif;font-size: 15px;text-align: left;padding-right: 30px;padding-left: 30px;">
            22.&nbsp;<strong>Los contratos y obligaciones de los empleados de los comerciantes en lo que concierne al
                comercio del negociante que los tiene a su servicio.</strong></h2>
        <h2 style="    text-indent: 10px;color: rgb(0,0,0);font-family: Thasadith, sans-serif;font-size: 15px;text-align: left;padding-right: 30px;padding-left: 30px;">
            23.&nbsp;<strong>&nbsp;La enajenación que el propietario o el cultivador hagan de los productos de su finca
                o de su cultivo.</strong></h2>
        <h2 style="    text-indent: 10px;color: rgb(0,0,0);font-family: Thasadith, sans-serif;font-size: 15px;text-align: left;padding-right: 30px;padding-left: 30px;">
            24.&nbsp;<strong>Las operaciones contenidas en la Ley General de Títulos y Operaciones de Crédito.</strong>
        </h2>
        <h2 style="    text-indent: 10px;color: rgb(0,0,0);font-family: Thasadith, sans-serif;font-size: 15px;text-align: left;padding-right: 30px;padding-left: 30px;">
        ...
        <h2 style="    text-indent: 10px;color: rgb(0,0,0);font-family: Thasadith, sans-serif;font-size: 15px;text-align: left;">
            <label style="color: rgb(225,178,24);height: 12px;"><strong>Concurso
                ...
                bienes que la integran para el pago a los acreedores reconocidos.</strong><br></h2>
    </div>
    <div class=" collapse" id="collapseFamiliar" style="margin-bottom: 20px;>
            <h1 style=" color: rgb(225,178,24);font-family: Thasadith, sans-serif;
    "></h1>
    <h1 style="color: rgb(225,178,24);font-family: Thasadith, sans-serif;">Derecho Familiar</h1>
    <h2 style="    text-indent: 10px;color: rgb(0,56,105);font-family: Thasadith, sans-serif;font-size: 20px;text-align: left;">Conjunto de
        ...
        y derechos reales sobre los mismos. <br></h2>
    <h2 style="    text-indent: 10px;color: rgb(0,0,0);font-family: Thasadith, sans-serif;font-size: 15px;text-align: left;">Es la parte
        ...
        <br></h2>
    <h2 style="text-indent: 10px;color: rgb(0,0,0);font-family: Thasadith, sans-serif;font-size: 15px;text-align: left;">El Derecho
    ...
    <h2 style="    text-indent: 10px;color: rgb(0,0,0);font-family: Thasadith, sans-serif;font-size: 15px;text-align: left;">
        <label style="color: rgb(225,178,24);height: 12px;"><strong>Alimentos.&nbsp;</strong><br></label><strong>Aunado
            ...
            cesar cuando se dan en la especie los supuestos previstos por la ley.</strong><br></h2>
    </div>
    <div class=" collapse" id="collapsePenal" ;>

        <h1 style="color: rgb(225,178,24);font-family: Thasadith, sans-serif;">Derecho Penal</h1>
        <h2 style="    text-indent: 10px;color: rgb(0,56,105);font-family: Thasadith, sans-serif;font-size: 20px;text-align: left;">El
            Derecho Penal se ubica dentro del Derecho Público toda vez que el Estado interviene activamente en la
            solución de conflictos buscando preservar el orden y la paz públicos. <br></h2>
        <h2 style="    text-indent: 10px;color: rgb(0,0,0);font-family: Thasadith, sans-serif;font-size: 15px;text-align: left;">El Derecho
        ...
        <h2 style="    text-indent: 10px;color: rgb(0,0,0);font-family: Thasadith, sans-serif;font-size: 15px;text-align: left;;">
            <label style="color: rgb(225,178,24);height: 12px;"><strong>Legislación Aplicable en el Derecho Penal
                ...
                cometieron.</strong><br><br><label style="text-indent: 10px">Los Códigos Penales Estatales se aplicarán a los delitos que esos
                códigos regulen y que se comentan en el Estado de que se trate, o bien a los delitos que se inicien o
                cometan en un Estado distinto o en la Ciudad de México, cuando se trate de delitos permanentes o
                continuados que se sigan cometiendo dentro del Estado de que se trate. En estos códigos se establecen
                disposiciones relativas a la definición de delito; la descripción de las conductas u omisiones que
        ...
        <h2 style="    text-indent: 10px;color: rgb(0,0,0);font-family: Thasadith, sans-serif;font-size: 15px;text-align: left;">
            <label style="color: rgb(225,178,24);height: 12px;"><strong>Delito.&nbsp;</strong><br></label><strong>El
                ...
                continuados.</strong><br></h2>
        <h2 style="    text-indent: 10px;color: rgb(0,0,0);font-family: Thasadith, sans-serif;font-size: 15px;text-align: left;padding-right: 30px;padding-left: 30px;">
            1.&nbsp;<strong>Los delitos instantáneos: son aquellos que se agotan en el mismo momento en que se han
                realizado todos los elementos de la descripción penal. Por ejemplo, el homicidio y el
                robo.&nbsp;</strong></h2>
        <h2 style="    text-indent: 10px;color: rgb(0,0,0);font-family: Thasadith, sans-serif;font-size: 15px;text-align: left;padding-right: 30px;padding-left: 30px;">
            2.&nbsp;<strong>Los delitos permanentes: son aquellos cuya consumación se prolonga en el tiempo. Por
                ejemplo, el abandono de incapaz.&nbsp;</strong></h2>
        <h2 style="    text-indent: 10px;color: rgb(0,0,0);font-family: Thasadith, sans-serif;font-size: 15px;text-align: left;padding-right: 30px;padding-left: 30px;">
            3.&nbsp;<strong>Los delitos continuados: son aquellos que se cometen con un mismo propósito delictivo y
        ...
        <h2 style="    text-indent: 10px;color: rgb(0,0,0);font-family: Thasadith, sans-serif;font-size: 15px;text-align: left;padding-right: 30px;padding-left: 30px;">
            1. Sujeto Activo:&nbsp;<strong>Es la persona que realiza la conducta considerada como delito. Por ejemplo,
                quien comete el delito de secuestro, denominado secuestrador.</strong><br></h2>
        <h2 style="    text-indent: 10px;color: rgb(0,0,0);font-family: Thasadith, sans-serif;font-size: 15px;text-align: left;padding-right: 30px;padding-left: 30px;">
        ...
        <h2 style="    text-indent: 10px;color: rgb(0,0,0);font-family: Thasadith, sans-serif;font-size: 15px;text-align: left;">
            <label style="color: rgb(225,178,24);height: 12px;"><strong>Responsabilidad
                ...
                delito:</strong><br></h2>
        <h2 style="    text-indent: 10px;color: rgb(0,0,0);font-family: Thasadith, sans-serif;font-size: 15px;text-align: left;padding-right: 30px;padding-left: 30px;">
            1.&nbsp;<strong> Los que preparen la realización de un delito.</strong></h2>
        <h2 style="    text-indent: 10px;color: rgb(0,0,0);font-family: Thasadith, sans-serif;font-size: 15px;text-align: left;padding-right: 30px;padding-left: 30px;">
            2. <strong>El que realice el delito.</strong><br></h2>
        <h2 style="    text-indent: 10px;color: rgb(0,0,0);font-family: Thasadith, sans-serif;font-size: 15px;text-align: left;padding-right: 30px;padding-left: 30px;">
            3.&nbsp;<strong>Los que realicen el delito de forma conjunta.</strong><br></h2>
        <h2 style="    text-indent: 10px;color: rgb(0,0,0);font-family: Thasadith, sans-serif;font-size: 15px;text-align: left;padding-right: 30px;padding-left: 30px;">
            4.&nbsp;<strong>Los que lleven a cabo el delito valiéndose de otro.</strong><br></h2>
        <h2 style="    text-indent: 10px;color: rgb(0,0,0);font-family: Thasadith, sans-serif;font-size: 15px;text-align: left;padding-right: 30px;padding-left: 30px;">
            5.&nbsp;<strong>Los que determinen dolosamente a otro a cometerlo.</strong></h2>
        <h2 style="    text-indent: 10px;color: rgb(0,0,0);font-family: Thasadith, sans-serif;font-size: 15px;text-align: left;padding-right: 30px;padding-left: 30px;">
            6.&nbsp;<strong>Los que dolosamente presten ayuda a otro para la comisión del delito</strong></h2>
        <h2 style="    text-indent: 10px;color: rgb(0,0,0);font-family: Thasadith, sans-serif;font-size: 15px;text-align: left;padding-right: 30px;padding-left: 30px;">
            7.&nbsp;<strong>Los que con posterioridad a su ejecución auxilien al que lo cometió en cumplimiento a una
                promesa anterior al delito.</strong></h2>
        <h2 style="    text-indent: 10px;color: rgb(0,0,0);font-family: Thasadith, sans-serif;font-size: 15px;text-align: left;padding-right: 30px;padding-left: 30px;">
        ...
        <h2 style="    text-indent: 10px;color: rgb(0,0,0);font-family: Thasadith, sans-serif;font-size: 15px;text-align: lefttext-align: left;">
            <label style="color: rgb(225,178,24);height: 12px;"><strong>Nuevo Sistema de Justicia
                ...
                disposiciones generales y otro que se refiere al procedimiento.</strong><br></h2>
        <br><br>
    </div>
    </div>
    </div>
...
<script>
    $(document).ready(function () {
        ...
        $('#collapseHipotecario').on('shown.bs.collapse', function (e) {
            $('#navHipotecario').addClass('active')
            $('#navHipotecario').addClass('disabled')


        })
        $('#collapseHipotecario').on('hidden.bs.collapse', function (e) {
            $('#navHipotecario').removeClass('active')
            $('#navHipotecario').removeClass('disabled')
        })
        $('#collapseCivil').on('shown.bs.collapse', function (e) {
            $('#navCivil').addClass('active')
            $('#navCivil').addClass('disabled')
        })
        $('#collapseCivil').on('hidden.bs.collapse', function (e) {
            $('#navCivil').removeClass('active')
            $('#navCivil').removeClass('disabled')

        })
        $('#collapseMercantil').on('shown.bs.collapse', function (e) {
            $('#navMercantil').addClass('active')
            $('#navMercantil').addClass('disabled')
        })
        $('#collapseMercantil').on('hidden.bs.collapse', function (e) {
            $('#navMercantil').removeClass('active')
            $('#navMercantil').removeClass('disabled')

        })
        $('#collapseFamiliar').on('shown.bs.collapse', function (e) {
            $('#navFamiliar').addClass('active')
            $('#navFamiliar').addClass('disabled')
        })
        $('#collapseFamiliar').on('hidden.bs.collapse', function (e) {
            $('#navFamiliar').removeClass('active')
            $('#navFamiliar').removeClass('disabled')

        })
        $('#collapsePenal').on('shown.bs.collapse', function (e) {
            $('#navPenal').addClass('active')
            $('#navPenal').addClass('disabled')
        })
        $('#collapsePenal').on('hidden.bs.collapse', function (e) {
            $('#navPenal').removeClass('active')
            $('#navPenal').removeClass('disabled')
